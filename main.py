...
def plot_model(data, model, inx):
    ...
    def plot_losses():
        ...
        plot.plot(range(50), model.losses, color='orange')
    plot_data_and_model()
    plot_losses()
...
if __name__ == '__main__':
    ...
    for inx, optimizer in enumerate([SGD(), Momentum()]):
        model = LinearModel() \
            .compile(loss_func=loss_mse, optimizer=optimizer) \
            .fit(dataset, epoch=50)
